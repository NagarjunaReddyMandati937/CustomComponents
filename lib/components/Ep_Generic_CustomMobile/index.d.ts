...
declare function EpGenericCustomMobile(props: any): JSX.Element;
declare namespace EpGenericCustomMobile {
    ...
    namespace propTypes {
        ...
        const datasource_1: PropTypes.Requireable<PropTypes.ReactNodeLike>;
