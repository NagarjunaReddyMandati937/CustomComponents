...
export const datetimedisplayformatter = (formatter) => {
  ...
  switch (formatter) {
    ...
    case "DateTime-DDMMYYYY": {
      objectvalues.variantVal = "datetime";
      objectvalues.formatVal = "DD/MM/YYYY"; // Specify your desired format here
      break;
    }
    default: {
      // Handle invalid formatter value
      console.warn(`Invalid formatter: "${formatter}". Using default format.`);
      objectvalues.variantVal = "datetime";
      objectvalues.formatVal = "DD/MM/YYYY"; // Use your preferred default format here
    }
  }
  return objectvalues;
};
